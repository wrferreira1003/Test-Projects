    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} md={6}>
        <MainCard title="Draggable Marker">
          <MapContainerStyled>
            <DraggableMarker {...mapConfiguration} mapStyle={theme.palette.mode === 'dark' ? MAPBOX_THEMES.dark : MAPBOX_THEMES.light} />
          </MapContainerStyled>
        </MainCard>
      </Grid>
      <Grid item xs={12}>
      ...
      <Grid item xs={12}>
        <MainCard title="Clusters">
          <MapContainerStyled>
            <ClustersMap {...mapConfiguration} mapStyle={theme.palette.mode === 'dark' ? MAPBOX_THEMES.dark : MAPBOX_THEMES.light} />
          </MapContainerStyled>
        </MainCard>
      </Grid>
      <Grid item xs={12}>
        <MainCard title="Interaction">
          <MapContainerStyled>
            <InteractionMap {...mapConfiguration} mapStyle={theme.palette.mode === 'dark' ? MAPBOX_THEMES.dark : MAPBOX_THEMES.light} />
          </MapContainerStyled>
        </MainCard>
      </Grid>
      <Grid item xs={12}>
      ...
      <Grid item xs={12} md={6}>
        <MainCard title="Highlight By Filter">
          <MapContainerStyled>
            <HighlightByFilter {...mapConfiguration} mapStyle={theme.palette.mode === 'dark' ? MAPBOX_THEMES.dark : MAPBOX_THEMES.light} />
          </MapContainerStyled>
        </MainCard>
      </Grid>
      <Grid item xs={12} md={6}>
        <MainCard title="Heatmap">
          <MapContainerStyled>
            <Heatmap {...mapConfiguration} mapStyle={theme.palette.mode === 'dark' ? MAPBOX_THEMES.dark : MAPBOX_THEMES.light} />
          </MapContainerStyled>
        </MainCard>
      </Grid>
      <Grid item xs={12}>
