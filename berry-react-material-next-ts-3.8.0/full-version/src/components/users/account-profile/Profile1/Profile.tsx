            ...
            <SubCard title="Skills">
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                  ...
                  <LinearProgressWithLabel color="primary" aria-label="junior skill progress" variant="determinate" value={70} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">UX Researcher</Typography>
                  <LinearProgressWithLabel color="primary" aria-label="Researcher skill progress" variant="determinate" value={80} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">Wordpress</Typography>
                  <LinearProgressWithLabel color="secondary" aria-label="Wordpress skill progress" variant="determinate" value={25} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">Graphic Designer</Typography>
                  <LinearProgressWithLabel color="primary" aria-label="Graphic design skill progress" variant="determinate" value={80} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">HTML</Typography>
                  <LinearProgressWithLabel color="secondary" aria-label="HTML skill progress" variant="determinate" value={45} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">PHP</Typography>
                  <LinearProgressWithLabel color="primary" aria-label="Graphic skill progress" variant="determinate" value={65} />
                </Grid>
              </Grid>
            </SubCard>
          </Grid>
