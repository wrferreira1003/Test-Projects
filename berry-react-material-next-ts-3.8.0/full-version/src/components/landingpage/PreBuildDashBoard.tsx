      ...
      <Grid container spacing={7.5} justifyContent="center" sx={{ px: 1.25 }}>
        ...
        <Grid item xs={12}>
          ...
          >
            ...
            >
              <Items title="Mail/Message App" image={theme.palette.mode === 'dark' ? SliderDark5 : SliderLight5} link="/apps/mail" />
              <Items title="Chat App" image={theme.palette.mode === 'dark' ? SliderDark3 : SliderLight3} link="/apps/chat" />
              <Items title="Kanban App" image={theme.palette.mode === 'dark' ? SliderDark4 : SliderLight4} link="/apps/kanban/board" />
              <Items title="Calendar App" image={theme.palette.mode === 'dark' ? SliderDark2 : SliderLight2} link="/apps/calendar" />
              <Items
                title="Ecommerce App"
